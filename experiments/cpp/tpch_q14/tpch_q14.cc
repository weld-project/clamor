  ...
  case Cluster::Role::DRIVER:
    {
      ...
      //string part_url = "http://weld-dsm-east.s3.amazonaws.com/part";
      string part_url = "/home/ubuntu/clamor/baselines/tpch_data/part_large";
      auto mapped_part = driver.map_url(part_url, /*local=*/true);
      ...
      string query_p0 = Util::read("tpch_q14_phase0.weld");
      weld_vector args_p0;
      args_p0.data = mapped_part.first;
      args_p0.length = mapped_part.second / sizeof(Part);
      weld_vector* res_p0 = (weld_vector*)driver.run_query(
                              query_p0, &args_p0, nprocs * worker_ips.size());

      string query_p1 = Util::read("tpch_q14_phase1.weld");
      weld_vector args_p1;
      ...
      weld_args args_p2;
      args_p2.parts = *res_p0;
      args_p2.lineitems = *res_p1;
      
      string query_p2 = Util::read("tpch_q14_phase2.weld");
